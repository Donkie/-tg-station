...
// These are indexes in a list
#define AREA_USAGE_EQUIP   1
#define AREA_USAGE_LIGHT   2
#define AREA_USAGE_ENVIRON 3
/// Number of usage channels
#define AREA_USAGE_LEN AREA_USAGE_ENVIRON
/// Index of the first usage channel
#define AREA_USAGE_START AREA_USAGE_EQUIP
/// Index of the last usage channel
#define AREA_USAGE_END AREA_USAGE_ENVIRON
