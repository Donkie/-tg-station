...
/obj/machinery/power/port_gen/pacman/examine(mob/user)
	. = ..()
	. += "<span class='notice'>The generator has [sheets] units of [sheet_name] fuel left, producing [siunit(power_gen, "W", 1)] per cycle.</span>"
	if(anchored)
...
/obj/machinery/power/port_gen/pacman/ui_data()
	...
	data["power_generated"] = siunit(power_gen, "W", 1)
	data["power_output"] = siunit(power_gen * power_output, "W", 1)
	data["power_available"] = (powernet == null ? 0 : siunit(avail(), "W", 1))
