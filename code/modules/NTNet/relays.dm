...
/obj/machinery/ntnet_relay
	...
	active_power_usage = 5000 //5kW, apropriate for machine that keeps massive cross-Zlevel wireless network operational. Used to be 10 but that actually drained the smes one round
	idle_power_usage = 50
